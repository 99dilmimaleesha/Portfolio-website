      ...
      <div className={`fixed inset-y-0 right-0 w-64 bg-white shadow-lg transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out md:hidden`}>
        <div className="p-4">
          <ul className="space-y-4 text-lg font-medium">
            <li><a href="#about" onClick={toggleSidebar} className="hover:underline">About</a></li>
            <li><a href="#experience" onClick={toggleSidebar} className="hover:underline">Experience</a></li>
            <li><a href="#projects" onClick={toggleSidebar} className="hover:underline">Projects</a></li>
            <li><a href="#contact" onClick={toggleSidebar} className="hover:underline">Contact</a></li>
          </ul>
